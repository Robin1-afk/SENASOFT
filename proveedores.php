    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
         ...
         <h1 class="h3 mb-2 text-gray-800">Provedores</h1>


    <form id="contact-form" method="post" action="registros/re_proveedores.php" role="form">
      ...
      <div class="controls">
          ...
          <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input id="form_name" type="text" name="nit" class="form-control" placeholder="ingrese nit *" required="required" data-error="Firstname is required.">
                      <div class="help-block with-errors"></div>
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      <label for="form_lastname">Razon Social</label>
                      <input id="form_lastname" type="text" name="razon" class="form-control" placeholder="Nombre de la sucursal *" required="required" data-error="Lastname is required.">
                      <div class="help-block with-errors"></div>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      <label for="form_email">Telefono 2</label>
                      <input id="form_name" type="text" name="telefono2" class="form-control" placeholder="Telefono 2" >
                      <div class="help-block with-errors"></div>
                  </div>
              </div>
          </div>
          <div class="row">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input id="form_name" type="text" name="direccion" class="form-control" placeholder="direccion" >
                      <div class="help-block with-errors"></div>
                  </div>
              </div>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tabla de Provedores</h6>
            </div>
            <div class="card-body">
                ...
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                  <div class="row"><div class="col-sm-12">
                    ...
                    <tr>
                      ...
                      <th rowspan="1" colspan="1">Razon social</th>
                      <th rowspan="1" colspan="1">Telefono 1</th>
                      <th rowspan="1" colspan="1">Telefono 2</th>
